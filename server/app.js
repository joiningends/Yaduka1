...
UserUnder.belongsTo(userTable, {
  foreignKey: "underValues",
  as: "valueofunder",
});

SpaceDetails.belongsTo(SpaceType, { foreignKey: "type" });
Location.hasMany(SpaceDetails, {
  as: "spaceDetails",
...
Contract.belongsTo(GstRate, {
  foreignKey: "gstrate",
  as: "gstRate",
  allowNull: true,
});
Contract.belongsTo(GstType, {
  foreignKey: "gsttype",
  as: "gstType",
  allowNull: true,
});
//Contract.belongsTo(userTable, { foreignKey: 'partyId', as: 'user' });
Contract.belongsTo(userTable, {
  foreignKey: "partyId",
  as: "partyuser",
  allowNull: true,
});
Contract.belongsTo(party, {
  foreignKey: "partyidinpartytable",
  as: "partyus",
  allowNull: true,
});
...
Storagespace.belongsTo(SpaceDetails, {
  foreignKey: "productspaces",
  as: "productSpaceDetails",
});
StoragespaceArea.belongsTo(SpaceDetails, {
  foreignKey: "Areaspaces",
  as: "AreaSpaceDetails",
});

Storagespace.belongsTo(ContractProduct, {
  foreignKey: "contractproduct",
  as: "contractp",
});
Storagespace.belongsTo(Contract, {
  as: "contractdet",
  foreignKey: "contractId",
});
StoragespaceArea.belongsTo(ContractSpace, {
  foreignKey: "contractspace",
  as: "contractspac",
});
...
Contract.hasMany(Invoice, { as: "invoice", foreignKey: "contract" });
userTable.hasMany(Invoice, { as: "admin", foreignKey: "userId" });
Invoice.belongsTo(Contract, { foreignKey: "contractId", as: "inv" });
...
Reproduct.belongsTo(ContractProduct, {
  foreignKey: "contractproductid",
  as: "contractproduct",
});
Requisition.hasMany(Reproduct, { as: "reproducts", foreignKey: "requationId" });
Requisition.belongsTo(userTable, {
  foreignKey: "underValues",
  as: "valueofunde",
});
...
Reproduct.belongsTo(Requisition, {
  as: "requtaion",
  foreignKey: "requationId",
});
