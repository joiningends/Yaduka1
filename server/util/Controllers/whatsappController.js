...
const sendWhatsAppMessage = (recipientNumber, message) => {
  ...
  const hisocialInstanceID = '654615C660E5';
    ...
    .then((response) => {
      if (!response.ok) {
        ...
        fetch(trackingServiceUrl, {
          method: 'POST',
          body: JSON.stringify({ clientId: '6516a9a7ab3554b246d9b014', sender: 'Yaduka', recipient: recipientNumber, content: message }),
          headers: { 'Content-Type': 'application/json' },
        })
    ...
    .then((response) => {
      if (!response.ok) {
        ...
        fetch(trackingServiceUrl, {
          ...
          method: 'POST',
          body: JSON.stringify({ clientId: '6516a9a7ab3554b246d9b014', sender: 'Yaduka', recipient: recipientNumber, content: mediaMessage }),
          headers: { 'Content-Type': 'application/json' },
        })
          .then((trackingResponse) => {
            if (trackingResponse.ok) {
