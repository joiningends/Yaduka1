...
function AddContract() {
  ...
  useEffect(() => {
    const fetchStorageOptions = async () => {
      try {
        const response = await axios.get(
          `https://www.keepitcool.app/api/v1/location/${userId}`
        );
    ...
    const fetchPartyOptions = async () => {
      try {
        const response = await axios.get(
          "https://www.keepitcool.app/api/v1/users/all/party/all"
        );
    ...
    const fetchGstRates = async () => {
      try {
        const response = await axios.get(
          "https://www.keepitcool.app/api/v1/gstrates"
        );
    ...
    const fetchGstTypes = async () => {
      try {
        const response = await axios.get(
          "https://www.keepitcool.app/api/v1/gsttypes"
        );
