...
function OngoingContractForManufectureAdmin() {
  ...
  useEffect(() => {
    setLoading(true);
    console.log(
      `https://www.keepitcool.app/api/v1/contracts/get/allongoing/${userId}`
    );
    axios
      .get(
        `https://www.keepitcool.app/api/v1/contracts/get/allongoing/${userId}`
...
export default OngoingContractForManufectureAdmin;
