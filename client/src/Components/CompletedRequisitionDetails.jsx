...
function CompletedRequisitionDetails() {
  const { id } = useParams();
  const [currentPage, setCurrentPage] = useState(1);
  const [currentTablePage, setCurrentTablePage] = useState(1);
  const [data, setData] = useState([]);
  const [requiredQuantities, setRequiredQuantities] = useState({}); // Declaration of requiredQuantities state
...
export default CompletedRequisitionDetails;
