...
function MaterialMovement() {
  ...
  const fetchLocations = () => {
    ...
    axios
      .get(`https://www.keepitcool.app/api/v1/ref/${id}`)
      .then(response => {
  ...
  const handleLocationChange = selectedOption => {
    ...
    axios
      .get(
        `https://www.keepitcool.app/api/v1/ref/manufactureid/${localStorage.getItem(
          "id"
  ...
  const handleSubmit = () => {
    ...
    axios
      .post(
        `https://www.keepitcool.app/api/v1/ref/requstion/${localStorage.getItem(
          "id"
