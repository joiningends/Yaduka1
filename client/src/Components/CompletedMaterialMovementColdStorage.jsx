...
function CompletedMaterialMovementColdStorage() {
  ...
  const fetchLocations = () => {
    ...
    axios
      .get(`https://www.keepitcool.app/api/v1/ref/material/completed/${id}`)
      .then(response => {
  ...
  const handleLocationChange = selectedOption => {
    ...
    axios
      .get(
        `https://www.keepitcool.app/api/v1/ref/manufactureid/complete/${localStorage.getItem(
          "id"
  ...
  const handleSubmit = () => {
    ...
    axios
      .post(
        `https://www.keepitcool.app/api/v1/ref/requstion/complete/${localStorage.getItem(
          "id"
