...
function AddRequisition() {
    ...
    async function fetchAdminOptions() {
      ...
      try {
        const response = await axios.get(
          "https://www.keepitcool.app/api/v1/users/adminall/coldstorage"
        );
  ...
  const handleAdminChange = async selectedAdminId => {
    ...
    try {
      const response = await axios.get(
        `https://www.keepitcool.app/api/v1/location/${selectedAdminId}`
      );
  ...
  const handleLocationChange = async selectedLocationId => {
    ...
    try {
      console.log(
        `https://www.keepitcool.app/api/v1/contracts/tabledata/${selectedAdminId}/${selectedLocationId}/${localStorage.getItem(
          "id"
        )}`
      );
      const response = await axios.get(
        ...
        <div className="row justify-content-center">
          <div className="col-md-8">
            <div className="card shadow" style={{ borderRadius: "2rem" }}>
              ...
              >
                <h4 className="card-title mb-0">Add Requisition</h4>
              </div>
